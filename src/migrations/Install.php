...
class Install extends Migration
{
    ...
    // craftcmsrouterosmanager_devicerecord table
        $tableSchema = Craft::$app->db->schema->getTableSchema('{{%craftcmsrouterosmanager_devicerecord}}');
        if ($tableSchema === null) {
            $tablesCreated = true;
            $this->createTable(
                '{{%craftcmsrouterosmanager_devicerecord}}',
                [
                    'id' => $this->primaryKey(),
    ...
    // craftcmsrouterosmanager_devicerecord table
        $this->addForeignKey(
            $this->db->getForeignKeyName('{{%craftcmsrouterosmanager_devicerecord}}', 'siteId'),
            '{{%craftcmsrouterosmanager_devicerecord}}',
            'siteId',
            '{{%sites}}',
            'id',
    ...
    {
    // craftcmsrouterosmanager_devicerecord table
        $this->dropTableIfExists('{{%craftcmsrouterosmanager_devicerecord}}');
    }
}
