 ...
 * @since     0.1
 */
class ConfigapplyController extends Controller
{
    // Public Methods
    // =========================================================================
    ...
    public function actionIndex()
    {
        ...
        echo "Welcome to the console ConfigapplyController actionIndex() method\n";
    ...
    public function actionDoSomething()
    {
        ...
        echo "Welcome to the console ConfigapplyController actionDoSomething() method\n";
