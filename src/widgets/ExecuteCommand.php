...
use RouterOS\Manager\assetbundles\executecommandwidget\ExecuteCommandWidgetAsset;
 ...
 * @since     0.1
 */
class ExecuteCommand extends Widget
{
    ...
    {
        return Craft::t('routeros-manager', 'ExecuteCommand');
    }
    ...
    {
        return Craft::getAlias("@evilfreelancer/craftcmsrouterosmanager/assetbundles/executecommandwidget/dist/img/ExecuteCommand-icon.svg");
    }
