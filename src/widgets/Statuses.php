...
namespace RouterOS\Manager\widgets;

use RouterOS\Manager\Plugin;
use RouterOS\Manager\assetbundles\statuseswidget\StatusesWidgetAsset;

use Craft;
use craft\base\Widget;

/**
 * CraftCMS RouterOS manager Widget
 *
...
class Statuses extends Widget
{
    ...
    {
        return Craft::t('routeros-manager', 'Statuses');
    }
    ...
    {
        return Craft::getAlias("@evilfreelancer/craftcmsrouterosmanager/assetbundles/statuseswidget/dist/img/Statuses-icon.svg");
    }
    ...
    public function getSettingsHtml()
    {
        return Craft::$app->getView()->renderTemplate(
            'craft-cms-router-os-manager/_components/widgets/Statuses_settings',
            [
                'widget' => $this
            ]
        );
    ...
    {
        Craft::$app->getView()->registerAssetBundle(StatusesWidgetAsset::class);

        return Craft::$app->getView()->renderTemplate(
            'craft-cms-router-os-manager/_components/widgets/Statuses_body',
            [
