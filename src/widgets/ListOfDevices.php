...
use RouterOS\Manager\assetbundles\listofdeviceswidget\ListOfDevicesWidgetAsset;
 ...
 * @since     0.1
 */
class ListOfDevices extends Widget
{
    ...
    {
        return Craft::t('routeros-manager', 'ListOfDevices');
    }
    ...
    {
        return Craft::getAlias("@evilfreelancer/craftcmsrouterosmanager/assetbundles/listofdeviceswidget/dist/img/ListOfDevices-icon.svg");
    }
